...
<div>
	<div class="col-sm-9">
    	...
    	<pk-input sm="6" label="地址">
    		<input type="text" class="form-control" @blur="searchByStationName(data.address)" v-on:keyup.enter="searchByStationName(data.address)" v-model="data.address" name="">
