// ui组件
export const pkInput = require('./pkInput') // 输入框模块
export const pkPanel = require('./pkPanel') // 表单模块
export const pkSingleImg = require('./pkSingleImg') // 上传图片模块
export const pkAlert = require('./pkAlert') // 弹框模块
export const pkTable = require('./pkTable') // 表格模块
